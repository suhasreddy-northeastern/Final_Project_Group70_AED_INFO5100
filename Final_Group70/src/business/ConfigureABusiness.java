...
import business.Role.GeneralMaintenanceRole;
...
public class ConfigureABusiness {
    ...
    public static Business configure() {
        ...
        organisation.setName("Living Ease");
...
//        MiticidesTeamRole
        ...
        org4.getUserAccountDirectory().createUserAccount("GenMaint1", "GenMaint1", org4, new GeneralMaintenanceRole());
        org4.getUserAccountDirectory().createUserAccount("GenMaint2", "GenMaint2", org4, new GeneralMaintenanceRole());
        org4.getUserAccountDirectory().createUserAccount("GenMaint3", "GenMaint3", org4, new GeneralMaintenanceRole());
