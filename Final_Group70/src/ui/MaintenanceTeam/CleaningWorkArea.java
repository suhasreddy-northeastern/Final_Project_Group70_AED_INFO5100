...
public class CleaningWorkArea extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(253, 252, 195));
        ...
        tblAssigned.setFont(new java.awt.Font("Helvetica Neue", 0, 18)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(layout.createSequentialGroup()
                                    .addComponent(btnProcess, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : par.getWorkQueue().getWorkRequestList()) {
            if ("Cleaning".equalsIgnoreCase(request.getType())) {
    ...
    public void populateme() {
        ...
        for (WorkRequest workl : account.getWorkQueue().getWorkRequestList()) {
            if ("Cleaning".equalsIgnoreCase(workl.getType())) {
                Object[] row = new Object[5];
                row[0] = workl;
